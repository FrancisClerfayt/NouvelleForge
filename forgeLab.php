...
<body>
  ...
  <main>
    ...
    <div class="description">
      <div class="imgDesc">
        <img src="img/forgelab_image7" alt="Photo de ForgeLab de la Nouvelle Forge">
      </div>
      <div class="textDesc">
        <p>
         L'équipe de la Nouvelle forge est heureuse de vous voir acceuillir dans son Fablab.
        </p>
		<p> Le "Forge Lab", atelier de fabrication numérique, est notamment équipéde :
		</p>
		<dl>
			<dt>&rarr; plusieurs imprimantes 3D,</dt>
			<dt>&rarr; d'une découpeuse laser, d'une découpeuse vinyle,</dt>
			<dt>&rarr; d'une découpeuse numérique, </dt>
	...
	<h3> Nos Machines </h3>
    <div class="machines">
	   <div class="imgMachines">
		<img src="img/imprimante_3D 1.png" alt="Photo de l'imprimante 3D Zortrax M200">
		<h5>Une imprimpante 3D</h5>
	...
	<a href="plusd'informations.html"/> Plus d'informations</u></a>
    </div>
			<!-- Description graveuse Speedy -->
	<div class="imgMachines">
		<img src="img/découpeuse_laser 1.png" alt="Photo de la graveuse Speedy">
		<h5>Une découpeuse laser</h5>
		
		<p>La Speedy est la machine de gravure laser idéale, 
	...
	<div class="imgMachines">
		<img src="img/fraiseuse_numerique 1.png" alt="Photo de la fraiseuse numérique Shopbot">
		<h5>Une Fraiseuse Numérique</h5>
		
		<p>La fraiseuse numérique Shopbot desktop Informations générales 
			Cette machine est utilisée pour l'usinage de précision. 
			Elle permet principalement d'usiner 
			Les principaux matériaux usinables comme le bois, plâtre, résine, cire usinable.</p>
	<a href="reserver.html"/> Réserver </a>
	<a href="seformer.html"/> Se former</a>
	<a href="plusd'informations.html"/> Plus d'informations</u></a>
    </div>
	<div class="imgMachines">
		...
		<img src="img/decoupeuse_vynile 1.png" alt="Photo de la découpeuse Vinyle Graphtex CR6000-60">
		<h5>Une Découpeuse Vinyle</h5>
		
		<p>Préparation à l'utilisation de la Graphtec CE6000-60 Informations générales 
			...
			Matériaux utilisés:
			Cette machine permet de découper principalement du vinyle,vinyle réfléchissant, flex.</p>
	<a href="reserver.html"/> Réserver </a>
	<a href="seformer.html"/> Se former</a>
	<a href="plusd'informations.html"/> Plus d'informations</u></a>
    </div>
	...
	<div class="imgMachines">
		<img src="img/brodeuse_numerique 1.png" alt="Photo de la brodeuse numérique">
